...
import { Megaphone, CheckCircle, XCircle, MessageSquare, ChevronDown, ChevronRight, Loader2 } from 'lucide-react';
    ...
    <div>
      ...
      {!loading && !fetchError && items.length === 0 && (
        <div className="flex flex-col items-center text-center py-16">
          ...
          <h2 className="text-[18px] font-semibold" style={{ color: '#1c1e21' }}>
            No pending reviews
          </h2>
          <p className="text-[14px] mt-1" style={{ color: '#65676b' }}>
